...
public class Appointment {
    ...
    private String appointmentType; // Consulta, Control, Urgencia
    private String status;           //PENDING, COMPLETED, CANCELLED
    private String reason;           //Motivo de la cita u observaciones
    ...
    public Appointment build() {
        ...
        if (appointment.dateTime == null) {
            throw new IllegalStateException("Appointment date/time is required");
        }
        return appointment;
    }
}
